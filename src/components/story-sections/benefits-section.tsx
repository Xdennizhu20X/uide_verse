...
const benefits = [
    {
        ...
        icon: BrainCircuit,
        iconBg: "bg-dark-navy dark:bg-accent-gold"
    },
    {
        ...
        <section className="w-full h-screen flex items-center justify-center overflow-hidden" style={{ scrollSnapAlign: 'start' }}>
            <div className="container px-4 mx-auto max-h-screen flex flex-col justify-center">
                ...
                >
                    ...
                    <h3 className="text-4xl md:text-5xl font-bold text-dark-navy dark:text-white pt-8 md:pt-12 ml-4">
                        ¿POR QUÉ UNIRTE?
                    </h3>
                </motion.div>
                    ...
                    {benefits.map((item, i) => (
                        ...
                        >
                            <div className="h-full flex flex-col justify-between bg-white dark:bg-[#152a58] rounded-3xl p-6 shadow-xl dark:shadow-2xl border border-slate-100 dark:border-[#1e3a6d] hover:scale-[1.03] hover:shadow-2xl transition-all duration-300">
                                <div>
                                    <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-6 text-white dark:text-dark-navy shadow-lg ${item.iconBg}`}>
                                        <item.icon className="w-8 h-8" />
                                    </div>
                                    <h4 className="text-2xl md:text-3xl font-bold text-dark-navy dark:text-white mb-4">{item.title}</h4>
